...
import Controlador.ArregloUsuarios;
...
public class Mantenimiento_Usuarios extends JDialog implements ActionListener,
	...
	ArregloUsuarios a = new ArregloUsuarios();
	...
	protected void do_btnNuevo_actionPerformed(ActionEvent e) {
		txtCodigo.setText("" + a.Genera_Codigo());
	}
	...
	protected void do_btnModificar_actionPerformed(ActionEvent e) {
		...
		if (u == null) {
			...
			u.setNombres(getNombre());
			u.setApellidos(getApellidos());
			u.setCodigo_docum(getCodDocum());
			u.setDocumento(getDocumento());
			u.setArea(getArea());
			u.setCorreo(getCorreo());
			u.setTelefono(getTelefono());
			u.setFecha_ing(getFechaIng());
			u.setEstado(getEstado());
			a.grabar();
			mostrar_usuarios();
		}
	}
